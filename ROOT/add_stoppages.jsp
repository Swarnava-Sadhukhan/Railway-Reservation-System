                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-primary panel-transparent">
                                <div class="panel-heading panel-heading">
                                    <p>
                                        <h4>Add New Stoppages.</h4>
                                    </p>
                                </div>
                                <div class="panel-body form-text">
                                    <form method="get" action="add_stoppages_submit.jsp">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Train Number" name="train_no" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="station_id" placeholder="Stoppage Station ID" required>
                                        </div>
