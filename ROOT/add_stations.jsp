                        ...
                        <div class="col-xs-12">
                            <div class="panel panel-primary panel-transparent">
                                <div class="panel-heading panel-heading">
                                    <p>
                                        <h4>Add New Stations.</h4>
                                    </p>
                                </div>
                                <div class="panel-body form-text">
                                    <form method="get" action="add_stations_submit.jsp">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Station ID" name="station_id" required>
                                        </div>
                                        <div class="form-group">
